...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ApiserverHA)(nil), (*kubeadm.ApiserverHA)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_ApiserverHA_To_kubeadm_ApiserverHA(a.(*ApiserverHA), b.(*kubeadm.ApiserverHA), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeadm.ApiserverHA)(nil), (*ApiserverHA)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeadm_ApiserverHA_To_v1beta2_ApiserverHA(a.(*kubeadm.ApiserverHA), b.(*ApiserverHA), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_ApiserverHA_To_kubeadm_ApiserverHA(in *ApiserverHA, out *kubeadm.ApiserverHA, s conversion.Scope) error {
	out.Enable = in.Enable
	out.Image = in.Image
	return nil
}

// Convert_v1beta2_ApiserverHA_To_kubeadm_ApiserverHA is an autogenerated conversion function.
func Convert_v1beta2_ApiserverHA_To_kubeadm_ApiserverHA(in *ApiserverHA, out *kubeadm.ApiserverHA, s conversion.Scope) error {
	return autoConvert_v1beta2_ApiserverHA_To_kubeadm_ApiserverHA(in, out, s)
}

func autoConvert_kubeadm_ApiserverHA_To_v1beta2_ApiserverHA(in *kubeadm.ApiserverHA, out *ApiserverHA, s conversion.Scope) error {
	out.Enable = in.Enable
	out.Image = in.Image
	return nil
}

// Convert_kubeadm_ApiserverHA_To_v1beta2_ApiserverHA is an autogenerated conversion function.
func Convert_kubeadm_ApiserverHA_To_v1beta2_ApiserverHA(in *kubeadm.ApiserverHA, out *ApiserverHA, s conversion.Scope) error {
	return autoConvert_kubeadm_ApiserverHA_To_v1beta2_ApiserverHA(in, out, s)
}
...
func autoConvert_v1beta2_ClusterConfiguration_To_kubeadm_ClusterConfiguration(in *ClusterConfiguration, out *kubeadm.ClusterConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1beta2_ApiserverHA_To_kubeadm_ApiserverHA(&in.ApiserverHA, &out.ApiserverHA, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_kubeadm_ClusterConfiguration_To_v1beta2_ClusterConfiguration(in *kubeadm.ClusterConfiguration, out *ClusterConfiguration, s conversion.Scope) error {
	...
	out.FeatureGates = *(*map[string]bool)(unsafe.Pointer(&in.FeatureGates))
	out.ClusterName = in.ClusterName
	if err := Convert_kubeadm_ApiserverHA_To_v1beta2_ApiserverHA(&in.ApiserverHA, &out.ApiserverHA, s); err != nil {
		return err
	}
	return nil
}
